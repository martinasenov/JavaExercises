...
public class MyOffers {
    ...
    */
    ...
    //  2.1 Create 7 objects of Offer
        ...
        offer4.setInfo("TX","CapitalOne","SM",115000,true,false,false,true);
       ...
       // Write a program that can remove all the offers that are not from local
        ...
        localOffers.removeIf(p->!p.location.equals("VA"));   // removes the offer if it is not from local area
